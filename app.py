...
from azure.storage.fileshare import ShareServiceClient, generate_account_sas, \
...
class AzureNfsSnapshot(object):
    ...
    def subscriptions_list(self):
        ...
        for sub in SubscriptionClient(
                credential=self.azconn).subscriptions.list():
    ...
    def get_all_filestorage(self, subscriptions_list):
        ...
        for sub in subscriptions_list:
            resourceconn = ResourceManagementClient(credential=self.azconn,
                                                    subscription_id=sub)
